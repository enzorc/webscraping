...
browser.get("https://www.mecanicvallee.com/annuaire-des-entreprises/")
browser.find_element_by_xpath('''//*[@id="cn-accept-cookie"]''').click()
...
csv_df.to_pickle(PATH_FOLDER_CSV_SCRAP + "mecanicvallee")

csv_df.to_csv(PATH_FOLDER_CSV_SCRAP + "mecanicvallee.csv", sep='\t', encoding='utf-8')
csv_df.to_excel(PATH_FOLDER_CSV_SCRAP + "mecanicvallee.xlsx")
print('saved!')
